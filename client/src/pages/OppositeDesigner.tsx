    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-16 bg-secondary/30 border-b border-border">
        <div className="container">
          ...
          <p className="text-xl text-foreground/70 mb-6">Merges Pierre Cardin's Space Age geometry and modular tailoring with fencing and militaristic references from The Count of Monte Cristo, translating Edmond Dantès' calculated revenge into controlled, futuristic power dressing.</p>
          <div className="flex flex-wrap gap-3 mt-8">
            <span className="px-4 py-2 bg-secondary/50 border border-accent/30 rounded-full text-sm text-foreground/70">Pierre Cardin</span>
            <span className="px-4 py-2 bg-secondary/50 border border-accent/30 rounded-full text-sm text-foreground/70">Space Age Geometry</span>
            <span className="px-4 py-2 bg-secondary/50 border border-accent/30 rounded-full text-sm text-foreground/70">Militaristic</span>
            <span className="px-4 py-2 bg-secondary/50 border border-accent/30 rounded-full text-sm text-foreground/70">Modular Tailoring</span>
            <span className="px-4 py-2 bg-secondary/50 border border-accent/30 rounded-full text-sm text-foreground/70">Revenge Narrative</span>
          </div>
        </div>
      </section>
