...
export default function SolarSynthesis() {
  ...
  const galleryImages = [
    ...
    "/collections/solar-synthesis/page-04.png",
    "/collections/solar-synthesis/page-05.png",
    "/collections/solar-synthesis/page-06.png",
      ...
      <section className="py-16 bg-secondary/30 border-b border-border">
        <div className="container">
          ...
          <p className="text-lg text-foreground/70 mb-6">
            A solarpunk-inspired collection merging tailored silhouettes with fluid draping, knitwear, and technical construction, exploring harmony between body, environment, and technology.
          </p>
          <div className="flex gap-3 flex-wrap">
            <span className="px-3 py-1 bg-accent/20 text-accent rounded-full text-sm font-semibold">Solarpunk</span>
            <span className="px-3 py-1 bg-accent/20 text-accent rounded-full text-sm font-semibold">Architecture</span>
            <span className="px-3 py-1 bg-accent/20 text-accent rounded-full text-sm font-semibold">Technical Knitwear</span>
            <span className="px-3 py-1 bg-accent/20 text-accent rounded-full text-sm font-semibold">Environmental Harmony</span>
          </div>
        </div>
      </section>
        ...
        <div className="container max-w-5xl">
          <div className="relative bg-secondary/30 rounded-lg border border-border overflow-hidden" style={{ aspectRatio: "16/9" }}>
            <img
              ...
              alt={`Solar Synthesis slide ${currentSlide + 1}`}
