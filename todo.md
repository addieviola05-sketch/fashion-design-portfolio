...
- [ ] Digital Projects page - add project showcase (optional)
- [ ] Artwork page - add artwork showcase (optional)
...
- [x] Update Poppy War carousel to show all gallery items
- [x] Update Beyond Pittock carousel to show all gallery items
- [x] Update Opposite Designer carousel to show all gallery items

## Design & Styling Updates
- [x] Changed hero tagline from "Where Fabric Meets Character and Style" to "Design as Narrative"
- [x] Updated hero background image to moody artistic photograph
- [x] Changed all white text to cream color (amber-50) throughout site
